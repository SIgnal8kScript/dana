...
<head>
	...
	<!-- Website Title -->
	<title>
		<?php echo $product_info['product_name']; ?> - Installer
	</title>
								...
								<div class="card__content">
									<div class="card__content__head">
										<h3 class="card__title">
											<span><a target="_blank" class="text-red" href="<?php echo $item_url; ?>">
									...
									<div class="card__fade">
										...
										<div class="card__content__foot">
											<p>Copyright ©
												<?php echo date('Y'); ?> <a target="_blank" class="text-red"
													href="https://nemosofts.com">nemosofts</a> All rights reserved.
											</p>
											<div class="text-right">
												<a href="<?php echo $item_url; ?>" target="_blank"
													class="btn btn--primary btn--slide is-danger"
													style="min-width: 115px;">BUY</a>
												<?php if ($errors == true) { ?>
													<button type="button" id="next" class="btn btn--primary btn--slide"
														style="min-width: 115px;" disabled>Next</button>
												<?php } else { ?>
													<a href="index.php?step=0" class="btn btn--primary btn--slide"
														style="min-width: 115px;">Next</a>
												<?php } ?>
											</div>
										</div>
									</div>
											...
											<div class="card__content">
												...
												<div class="card__fade">
													<form action="index.php?step=1" method="POST">
														...
														<p style="margin-top: 10px;">Copyright ©
															<?php echo date('Y'); ?> <a target="_blank" class="text-red"
																href="https://nemosofts.com">nemosofts</a> All rights reserved.
														</p>
													</form>
									...
									<div class="card__content">
										...
										<div class="card__fade">
											<div class="notify notify--success mb-40">
												...
												<span class="notify__text">
													<?php echo $product_info['product_name']; ?> is successfully installed.
												</span>
											</div>
