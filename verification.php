    ...
    <div class="nsofts-container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center">
                <li class="breadcrumb-item d-inline-flex"><a href="dashboard.php"><i class="ri-home-4-fill"></i></a>
                </li>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="" name="addverify" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="envato_buyer_name" class="form-control"
                                        placeholder="Enter your envato user name"
                                        value="<?php echo $settings_row['envato_buyer_name']; ?>" autocomplete="off"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="envato_purchase_code" class="form-control"
                                        placeholder="Enter your item purchase code"
                                        value="<?php echo $settings_row['envato_purchase_code']; ?>" autocomplete="off"
                                        required>
                                    <small id="sh-text1" class="form-text text-muted"><a style="color: #f44336c7;"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="envato_api_key" class="form-control"
                                        placeholder="<?php echo $settings_row['envato_api_key']; ?>" disabled readonly>
                                    <small id="sh-text1" class="form-text text-muted col-md-6"
                                        style="padding: 0px;">Click the Save button This key will be generated
                                        automatically.</small>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="envato_package_name" class="form-control"
                                        placeholder="Enter your android application id"
                                        value="<?php echo $settings_row['envato_package_name']; ?>" autocomplete="off"
                                        required>
                            ...
                            <button type="submit" name="submit" class="btn btn-primary"
                                style="min-width: 120px;">Verify</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-primary alert-dismissible" role="alert">
                            ...
                            <p class="mb-0">Only one app can be active at a time. If you register new package name
                                previous app cant be access by users.</p>
                        </div>
