                            ...
                            <?php } else { ?>
                                <form action="login_db.php" method="post">
                                    <div class="text-center mb-3">
                                        <a href="index.php" class="fs-4 fw-semibold text-decoration-none">
                                            <?php echo APP_NAME; ?>
                                        </a>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="nsofts-input-icon nsofts-input-icon--left">
                                            ...
                                            <input type="text" name="user_login" id="user_login" class="form-control"
                                                autocomplete="off" placeholder="Enter your email or username" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between mb-1">
                                            <label for="nsofts_password_input"
                                                class="form-label fw-semibold mb-0">Password</label>
                                            <a href="auth_pass_recovery.php" class="text-decoration-none">Forgot
                                                Password?</a>
                                        </div>
                                        <div class="nsofts-input-icon nsofts-input-icon--both">
                                            ...
                                            <input type="password" name="nsofts_password_input" id="nsofts_password_input"
                                                class="form-control" autocomplete="off" placeholder="Enter your password"
                                                required>
                                            <button type="button" id="nsofts_password_toggler"
                                                class="nsofts-input-icon__right btn p-0 border-0 lh-1">
                                    ...
                                    <p class="text-center">New on our platform? <a href="auth_register.php"
